...
**Generated**: 2025-10-02T00:09:25.053856
**Framework**: Ultralytics YOLO (PyTorch)
**Evaluation Time**: 162.57 seconds
...
| Property | Value |
|----------|-------|
| **Model Path** | `models/optimized_npu/v3/level4_relu.pt` |
| **File Size** | 7.03 MB |
| **Task Type** | detect |
| **Device** | cpu |
...
| **Inference** | 222.11 | Model inference time |
| **Postprocess** | 0.28 | NMS and postprocessing time |
| **Total** | **223.45** | **Total pipeline time** |
